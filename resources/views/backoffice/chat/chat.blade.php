    ...
    <div class="h-[calc(100vh-80px)] w-full flex bg-transparent md:p-6 md:gap-6 overflow-hidden relative z-10">
        ...
        <div id="chat-sidebar"
            ...
            <div class="p-6 pb-2 shrink-0">
                <div class="relative flex items-center bg-white/95 rounded-2xl shadow-inner border border-white/20 px-3 group focus-within:ring-2 focus-within:ring-white/20 transition-all">
                    <span class="material-symbols-outlined text-gray-400 text-lg transition-colors group-focus-within:text-vendly flex-shrink-0">search</span>
                            ...
                            <div class="flex gap-4 items-center">
                                ...
                                <div class="w-12 h-12 rounded-xl border border-gray-100 overflow-hidden flex-shrink-0 bg-gray-50">
                                    @if($chat->product && $chat->product->images->isNotEmpty())
                                        <img src="{{ Storage::url($chat->product->images->first()->path) }}" class="w-full h-full object-cover" alt="">
                                    @else
        ...
        <div id="chat-window"
            ...
            <div class="text-center opacity-40 flex flex-col items-center p-6 scale-110">
                ...
                <h3 class="text-2xl font-black text-gray-800 mb-3 tracking-tight">{{ __('message.your_conversations') }}</h3>

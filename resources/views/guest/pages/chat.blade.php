...
@section('content-guest')
    <div class="h-[calc(100vh-80px)] w-full flex bg-white md:bg-gray-50 md:p-4 md:gap-4 overflow-hidden">
        ...
        <div id="chat-sidebar" class="flex w-full md:w-1/3 flex-col bg-white md:border md:border-gray-200 md:rounded-xl md:shadow-sm h-full overflow-hidden shrink-0">
            ...
            <div class="flex-1 overflow-y-auto p-2 space-y-1">
                ...
                <a href="#" class="chat-item-btn block w-full text-left p-3 border-l-4 border-transparent hover:bg-gray-50 hover:border-blue-300 rounded-r-lg transition">
        ...
        <div id="chat-window" class="hidden md:flex w-full md:w-2/3 flex-col h-full bg-gray-50 md:border md:border-gray-200 md:rounded-xl md:shadow-sm overflow-hidden items-center justify-center">

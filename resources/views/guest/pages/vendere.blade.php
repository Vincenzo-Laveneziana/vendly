...
@section('content-guest')
    ...
    <div class="relative -z-40 w-full mb-8 rounded-lg overflow-hidden shadow-lg h-96 md:h-96" style="background-image: url('{{ asset('images/imageVendere.webp') }}'); background-size: cover; background-position: center;">
        
        <!-- Contenuto in sovraimpressione (visibile su desktop) -->
        <div class="hidden md:flex absolute inset-0 items-center justify-end pr-12">
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-md">
                ...
                <a href="{{ route('vendere') }}" class="inline-flex items-center justify-center w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition duration-300 text-lg">

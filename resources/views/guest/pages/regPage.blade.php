    ...
    <div class="flex items-center justify-center h-full bg-gray-100">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg border border-gray-100">
            ...
            <form action="/registration" method="POST">
                ...
                <button 
                    type="submit" 
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold mt-4 px-4 py-3 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-0.5"
                >
                    Registrati
                </button>

        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 w-full flex flex-col lg:flex-row gap-6 relative z-10">
            ...
            <div class="w-full lg:w-[300px] flex-shrink-0 vue-island">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-black text-gray-900">{{ __('message.filters') }}</h2>
                            ...
                            <div class="px-1 mt-4 pb-2 w-full">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="text-center">
                                        <span class="text-xs text-gray-500 mr-1">{{ __('message.money') }}</span>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-3 text-sm font-bold text-gray-700">
                            <span>{{ __('message.location') }}</span>
                        </div>
                        <div class="relative group flex justify-center">
                            <input type="text" id="locationInput" placeholder="{{ __('message.search') }}"
            ...
            <div class="w-full lg:flex-1 flex flex-col gap-4">
                ...
                <div id="noResults"
                    ...
                    <p class="text-gray-500 font-medium">{{ __('message.no_ads_found_filters') }}</p>
                </div>

...
@section('content')
    ...
    <form action="/registration" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
                <label for="name" class="block text-sm font-semibold text-gray-600">Nome</label>
            ...
            <div class="space-y-1">
                <label for="surname" class="block text-sm font-semibold text-gray-600">Cognome</label>
                <input type="text" id="surname" name="surname" value="{{ old('surname') }}" maxlength="30" placeholder="Rossi"
                    class="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-vendly/20 focus:border-vendly transition duration-200 placeholder:text-gray-300"
                    required>
            </div>

            <div class="space-y-1">
                <label for="phone" class="block text-sm font-semibold text-gray-600">Numero di Telefono</label>
                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" maxlength="15" placeholder="3471802344"
                    class="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-vendly/20 focus:border-vendly transition duration-200 placeholder:text-gray-300">
            </div>

            <div class="space-y-1">
                <label for="DateOfBirth" class="block text-sm font-semibold text-gray-600">Data di Nascita</label>
        ...
        <div class="space-y-1">
            <label for="address_street" class="block text-sm font-semibold text-gray-600">Via</label>
        ...
        <div class="space-y-1">
            <label for="address_city" class="block text-sm font-semibold text-gray-600">Città</label>
        ...
        <div class="space-y-1">
            ...
            <input type="email" id="email" name="email" value="{{ old('email') }}" maxlength="40" placeholder="m@example.com"
                class="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-vendly/20 focus:border-vendly transition duration-200 placeholder:text-gray-300"
                required>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="space-y-1">
                <label for="password_confirmation" class="block text-sm font-semibold text-gray-600">Conferma Password</label>
